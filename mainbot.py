...
while True:
    user = api.get_user('boseayanava')
    api.update_profile(name=f'AYANAVA|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : AYANAVA|{follower_count(user)} Followers')
